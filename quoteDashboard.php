...
<body>
    ...
    <div class="sidebar row no-gutters mt-5">
        ...
        <div class="col-md-10">
            <div class="container">
                <h4 class="mt-4">Quotes - OmahNgilmu</h4>
                <div class="card mt-4 me-2">
                    <div class="card-header fw-bold">
                        <a href="inputQuote.php" class="btn bg-green fw-bold text-light"><i class="fa-solid fa-plus mx-2" href="inputQuote.php"></i>Tambah Baru</a>
                    </div>
                    <div class="card-body">
                        <table class="table table-bordered table-striped table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th><center>Id Quote</center></th>
                                    <th><center>Nama Quoter</center></th>
                                    <th width="500px"><center>Quote</center></th>
                            ...
                            <?php
                            $i = 1; ?>
                            <?php $result = mysqli_query($koneksi, "SELECT * FROM quote"); ?>
                            <?php foreach ($result as $row) : ?>
                            <tbody>
                                <tr>
                                    <td><?= $i; ?></td>
                                    <td><?= $row['id_quote']; ?></td>
                                    <td><?= $row['nama_quoter']; ?></td>
                                    <td><?= $row['isi_quote']; ?></td>
                                    <td><center>
                                        <a href="editQuote.php?id=<?php echo $row['id_quote'];?>" class="btn btn-warning text-light"><i class="fa-solid fa-pen"></i></a>
                                        <a href="HapusQuote.php?id=<?php echo $row['id_quote'];?>" class="btn btn-danger text-light"><i class="fa-solid fa-trash"></i></a>
                                    </center></td>
                                </tr>     
                            </tbody>
                            <?php $i++ ?>
