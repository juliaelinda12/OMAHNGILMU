                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            <div class="p-5 ps-4 text-dark">
                                ...
                                <p>Sudah punya Akun? <a href="login.php" class="text-success">Masuk</a></p>
                                ...
                                <div class="row">
                                    ...
                                    <div class="mt-3 col-12">
                                        <button type="submit" name="submit" class="btn tombol text-light">Buat Akun</button>
                                    </div>
                                    <p class="mt-2"><a href="registerAdmin.php" class="text-success">Buat</a> akun Admin</p>
                                </div>
                                </form>
                            </div>
                        </div>
...
if(isset($_POST['submit'])){
    ...
    if (mysqli_fetch_assoc($query)) {
        ...
        if($password == $repass){
            ...
            $query=mysqli_query($koneksi, "INSERT INTO users (username,name,email, password ) VALUES ('$username','$name','$email','$password')");
            if($query){
                echo"<script>
