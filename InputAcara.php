                ...
                <p>Bersama kami wujudkan Indonesia melek literasi</p>
                    <div class="card me-2">
                        ...
                        <div class="card-body mt-2">
                            <form action="prosesInputAcara.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                <div class="row g-3">
                                    <div class="col-sm-6 form-group mx-auto">
                                        <label for="kode_acara">Kode Acara</label>
                                        <input name="kode_acara" type="number" id="kode_acara" class="form-control" required>
                                    </div>
                                    <div class="col-sm-6 form-group mx-auto">
                                    ...
                                    <div class="col-sm-6 form-group mx-auto">
                                        ...
                                        <input name="nama_acara" type="text" id="nama_acara" class="form-control"required>
                                    </div>
                                    <div class="col-sm-6 form-group mx-auto">
                                        <label>Penyelenggara</label>
                                        <input name="penyelenggara" type="text" id="penyelenggara" class="form-control"required>
                                    </div>
                                    ...
                                    <div class="col-sm-6 form-group">
                                        ...
                                        <input name="acara" type="file" id="acara" class="form-control" required>
                                    </div>
                                    <div class="col-12">
                                    ...
                                    <button class="btn bg-green text-light" name="simpan" type="submit" id="simpan" value="Unggah Acara">Unggah Acara</button>
