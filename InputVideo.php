...
<body>
    ...
    <div class="sidebar row no-gutters mt-5">
        ...
        <div class="col-md-10">
            <div class="container">
                <h3 class="mt-3 fw-bold">OmahNgilmu - Unggah Video</h3>
                <p>Bersama kami wujudkan Indonesia melek literasi</p>
                    <div class="card me-2">
                        ...
                        <div class="card-body mt-2">
                            <form action="ProsesInputVideo.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                <div class="row g-3">
                                    <div class="col-sm-6 form-group mx-auto">
                                        <label for="kode_infografis">Kode Video</label>
                                        <input name="kode_video" type="number" id="kode_video" class="form-control" required>
                                    </div>
                                    <div class="col-sm-6 form-group mx-auto">
                                    ...
                                    <div class="col-sm-6 form-group mx-auto">
                                        ...
                                        <input name="judul_video" type="text" id="judul_video" class="form-control"required>
                                    </div>
                                    <div class="col-sm-6 form-group mx-auto">
                                    ...
                                    <div class="col-sm-6 form-group mx-auto">
                                        ...
                                        <textarea input name="deskripsi" type="text" id="deskripsi" class="form-control" placeholder="Tambahkan deskripsi"></textarea>
                                    </div>
                                    <div class="col-sm-6 form-group mx-auto">
                                        <label>Kategori</label>
                                        <select name="kategori" type="text" id="kategori" class="form-control" required>
                                    ...
                                    <div class="col-sm-6 form-group">
                                        ...
                                        <input name="video" type="url" id="video" class="form-control" required>
                                    </div>
                                    <div class="col-12">
                                    ...
                                    <button class="btn bg-green text-light" name="simpan" type="submit" id="simpan" value="Unggah Video">Unggah Video</button>
                                    <button class="btn btn-danger" name="reset" type="reset" id="reset" value="Kosongkan">Kosongkan</button>
                                </div>
                            </form>
                        </div>
                    </div>
