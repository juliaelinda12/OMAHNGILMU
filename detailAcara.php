<?php
    ...
    if (isset($_GET["kode_acara"])) {
        $kode_acara = ($_GET["kode_acara"]);
        
        $result = mysqli_query($koneksi, "SELECT * FROM acara WHERE kode_acara='$kode_acara'");
        ...
        <div class="container" style="margin-top: -90px;">
            <div class="row ">
                ...
                <div class="col-5">
                    ...
                    <img style="border-radius: 10px;" src="acara/<?= $row['acara']; ?>" class="vid" alt="<?= $row['nama_acara']; ?>">
                    </div>
                </div>
                <div class="col-7">
                    <div class="card vid-new p-3">
                        <h4 class="card-title"><?= $row['nama_acara']; ?></h4>
                        <p class="card-text"><small class="text-muted">Diupload pada <?= $row['tgl_acara']; ?></small></p>
                        <h6>Penyelenggara</h6>
